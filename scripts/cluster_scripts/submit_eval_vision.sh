...
# CHECKPOINT_DIR=/data/locomotion/abhi_ag/workspace/gcs-diffusion/data/outputs/iros/long_context_planar_pushing/skip_frame_study/unet_cross_attention/two_modes/data_24/skip_second_frame_mode_4_0/36_obs/checkpoints/
# HYDRA_RUN_DIR=eval/iros/long_context_planar_pushing/skip_frame_study/unet_cross_attention/two_modes/data_24/skip_second_frame_mode_4_0/36_obs/0
# RELATIVE_PATH_TO_DIFFUSION=../gcs-diffusion/
